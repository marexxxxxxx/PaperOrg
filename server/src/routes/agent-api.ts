...
const checkRoutingRules = (sourceDepartmentId: string | null, targetRoleId: string | null, targetDepartmentId: string | null): boolean => {
...
agentApiRouter.post('/tickets', (req, res) => {
  ...
  if (target_agent_id) {
      ...
      if (targetStmt.step()) {
          ...
          targetRoleId = targetAgent.role_id as string | null
          targetDepartmentId = targetAgent.department_id as string | null
      } else {
          targetStmt.free()
      ...
      // Check routing rules
      if (!checkRoutingRules(agent.department_id as string | null, targetRoleId, targetDepartmentId)) {
...
agentApiRouter.patch('/tickets/:id', (req, res) => {
  ...
  if (target_agent_id) {
      ...
      if (targetStmt.step()) {
          const targetAgent = targetStmt.getAsObject()
          const targetRoleId = targetAgent.role_id as string | null
          const targetDepartmentId = targetAgent.department_id as string | null
